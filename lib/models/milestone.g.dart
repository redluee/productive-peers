...
Milestone _milestoneDeserialize(
  ...
  object.percentage = reader.readDoubleOrNull(offsets[2]);
...
extension MilestoneQueryFilter
  ...
  QueryBuilder<Milestone, Milestone, QAfterFilterCondition> percentageIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Milestone, Milestone, QAfterFilterCondition> percentageEqualTo(
    double? value, {
  ...
  QueryBuilder<Milestone, Milestone, QAfterFilterCondition> percentageLessThan(
    double? value, {
    bool include = false,
    double epsilon = Query.epsilon,
  }) {
  ...
  QueryBuilder<Milestone, Milestone, QAfterFilterCondition> percentageBetween(
    double? lower,
    double? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Milestone, Milestone, QAfterFilterCondition> targetDateIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Milestone, Milestone, QAfterFilterCondition> targetDateEqualTo(
      DateTime? value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'targetDate',
  ...
  QueryBuilder<Milestone, Milestone, QAfterFilterCondition> targetDateLessThan(
    DateTime? value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Milestone, Milestone, QAfterFilterCondition> targetDateBetween(
    DateTime? lower,
    DateTime? upper, {
    bool includeLower = true,
    bool includeUpper = true,
